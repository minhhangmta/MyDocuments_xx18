...
<body>
	...
	<table class="tbl_list" border="1" cellpadding="4" cellspacing="0"
		...
		<tr class="tr2">
			...
			<th align="left">氏名 <a
				href="${pageContext.request.contextPath}/listUser?type=sort&typeSort=full_name">▲▽</a>
			</th>
			...
			<th align="left">日本語能力 <a
				href="${pageContext.request.contextPath}/listUser?type=sort&typeSort=code_level">▲▽</a>
			</th>
			<th align="left">失効日 <a
				href="${pageContext.request.contextPath}/listUser?type=sort&typeSort=end_date">△▼</a>
			</th>
			<th align="left">点数</th>
		</tr>
